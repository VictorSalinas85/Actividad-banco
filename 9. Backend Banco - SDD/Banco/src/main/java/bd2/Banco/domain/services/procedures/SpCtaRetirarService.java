...
import bd2.Banco.domain.dto.request.RetirarRequest;
...
public class SpCtaRetirarService {

    private final ProcedureCallHelper procedureCallHelper;

    @Transactional
    public SpResultado ejecutar(RetirarRequest request) {
        ...
        return procedureCallHelper.ejecutar("sp_cta_retirar", params);
    }
}
