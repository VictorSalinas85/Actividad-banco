...
public class CliEmpresa {
    ...
    @Column(name = "nit", nullable = false, length = 30) private String nit;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "representante_persona_id", nullable = false)
    private CliPersonaNatural representantePersona;
