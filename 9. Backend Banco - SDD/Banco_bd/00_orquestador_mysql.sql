PS D:\Universidad\Semestre 4\Bases de datos 2\Actividad-banco\9. Backend Banco - SDD\BASE.BD> cmd /c "C:\xampp\mysql\bin\mysql.exe -u root --password=Victsalinas85* < 00_orquestador_mysql.sql"
ERROR 1045 (28000): Access denied for user 'root'@'localhost' (using password: YES)
PS D:\Universidad\Semestre 4\Bases de datos 2\Actividad-banco\9. Backend Banco - SDD\BASE.BD>-- 00_orquestador_mysql.sql
